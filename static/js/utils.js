...
function task_comment_actions(opportunity_id, opportunity_name){
    let icons = '<div class="btn-group" role="group" aria-label="Task and Comment Actions">' +
                    '  <a type="button" class="btn btn-sm task-comment-btn border border-white" style="background-color: #0d6efd; color: white;" onclick="listTasks(' + opportunity_id + ', \'' + opportunity_name  + '\')" title="List Tasks">' +
                    ...
                    '    </svg>' +
                    '  </a>' +
                    '  <button type="button" class="btn btn-sm task-comment-btn border border-white" style="background-color: #0d6efd; color: white;" onclick="showCreateTaskModal(' + opportunity_id + ', \'' + opportunity_name + '\')" data-bs-toggle="tooltip" title="Create Task">' +
                    '    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-square" viewBox="0 0 16 16">' +
                    '      <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>' +
                    '      <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>' +
                    '    </svg>' +
                    '  </button>' +
                    '  <button type="button" class="btn btn-sm task-comment-btn border border-white" style="background-color: #0d6efd; color: white;" onclick="listComments(' + opportunity_id + ', \'' + opportunity_name + '\')" title="List Comments">' +
                    '    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-left-text" viewBox="0 0 16 16">' +
                    '      <path d="M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4.414A2 2 0 0 0 3 11.586l-2 2V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12.793a.5.5 0 0 0 .854.353l2.853-2.853A1 1 0 0 1 4.414 12H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>' +
                    '      <path d="M3 3.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zM3 6a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9A.5.5 0 0 1 3 6zm0 2.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5z"/>' +
                    '    </svg>' +
                    '  </button>' +
                    '  <button type="button" class="btn btn-sm task-comment-btn border border-white" style="background-color: #0d6efd; color: white;" onclick="showCreateCommentModal(' + opportunity_id + ', \'' + opportunity_name + '\')" title="Create Comment">' +
