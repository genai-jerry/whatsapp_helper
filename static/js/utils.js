...
function task_comment_actions(opportunity_id, opportunity_name, task_count, comment_count){
    ...
    let icons = '<div class="btn-group" role="group" aria-label="Task and Comment Actions">' +
                    ...
                    '    </svg>' +
                    '  </a>' +
                    '  <button type="button" class="btn btn-sm task-comment-btn border border-white" style="background-color: #0d6efd; color: white; cursor: pointer;" onclick="showCreateTaskModal(' + opportunity_id + ', \'' + opportunity_name + '\')" data-bs-toggle="tooltip" title="Create Task">' +
                    ...
                    '    </svg>' +
                    '  </button>' +
                    '  <button type="button" class="btn btn-sm task-comment-btn border border-white" style="background-color: #0d6efd; color: white; cursor: pointer;" onclick="listComments(' + opportunity_id + ', \'' + opportunity_name + '\')" title="List Comments">' +
                    '    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="' + commentListColor + '" class="bi bi-chat-left-text" viewBox="0 0 16 16">' +
                    '      <path d="M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4.414A2 2 0 0 0 3 11.586l-2 2V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12.793a.5.5 0 0 0 .854.353l2.853-2.853A1 1 0 0 1 4.414 12H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>' +
                    '      <path d="M3 3.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zM3 6a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9A.5.5 0 0 1 3 6zm0 2.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5z"/>' +
                    '    </svg>' +
                    '  </button>' +
                    '  <button type="button" class="btn btn-sm task-comment-btn border border-white" style="background-color: #0d6efd; color: white; cursor: pointer;" onclick="showCreateCommentModal(' + opportunity_id + ', \'' + opportunity_name + '\')" title="Create Comment">' +
                    '    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-chat-right-quote" viewBox="0 0 16 16">' +
